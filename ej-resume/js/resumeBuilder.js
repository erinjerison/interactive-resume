...
function displayWork() {
	for (job in work.jobs) {
		...
		// display them
		// FOR THE FUTURE -- HERE'S WHERE YOU MAY HAVE TRIPPED UP:
		// REMEMBER TO USE THE # TO CALL A CLASS
		// USE THE . TO CALL A MODIFIER OF A CLASS
...
// invoke displayWork() to get it to display
displayWork();
...
// call the function -- whenever the user clicks that internationalize button,
// it'll work.
inName(bio.name);
